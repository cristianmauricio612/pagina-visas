    ...
    <div class="py-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border max-w-3xl mx-auto">
            <form id="updateVisaForm">
                ...
                {{-- Meses de Espera --}}
                <div class="mb-4">
                    <label for="meses_espera" class="block text-gray-700 font-semibold mb-2">Tiempor de Espera (Meses)</label>
                    <input type="text" name="meses_espera" id="meses_espera" class="p-2 border rounded w-full" value="{{$visa->meses_espera}}" placeholder="00" required>
                </div>
