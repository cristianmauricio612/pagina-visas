            ...
            <ul>
                ...
                <li class="mb-2">
                    ...
                    <ul id="visas" class="ml-6 mt-1 hidden transition-all">
                        <li>
                            <a href="{{route('admin.visas.listView')}}"
                                class="flex items-center p-2 text-gray-300 hover:text-white hover:border-l-4 hover:border-white">
                                <i class="fas fa-list mr-2"></i> Listar
                            </a>
                        </li>
                        <li>
                            <a href="{{route('admin.visas.addView')}}"
                                class="flex items-center p-2 text-gray-300 hover:text-white hover:border-l-4 hover:border-white">
                                <i class="fas fa-plus-circle mr-2"></i> Crear
                            </a>
                        </li>
                ...
                <li class="mb-2">
                    ...
                    <ul id="pedidos" class="ml-6 mt-1 hidden transition-all">
                        <li>
                            <a href="{{route('admin.pedidos.listView')}}"
                                class="flex items-center p-2 text-gray-300 hover:text-white hover:border-l-4 hover:border-white">
                                <i class="fas fa-list mr-2"></i> Listar
                            </a>
                        </li>
            ...
            fetch("/admin/logout", {
                ...
                .then(data => {
                    if (data.status === "success") {
                        ...
                        window.location.href = "/admin/iniciar-sesion"; // Redirigir al login
                    } else {
