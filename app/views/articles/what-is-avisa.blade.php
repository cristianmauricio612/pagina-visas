    ...
    <div class="info-visa-container">
        <div class="return-page">
            <div class="small-title-page">
                ...
                <span> > </span>
                <b class="name-page">¿Qué es una visa? Definición y todos los tipos de visas.</b>
            </div>
        </div>
        <div class="title-page">
            ¿Qué es una visa? Definición y todos los tipos de visas.
        </div>
        <div class="text-page">
            <div class="info-text">
    ...
    <div class="info-container">
        <div class="division">
                        ...
                        <ul style="list-style: none; padding-left: 0%; margin-bottom: 0%;">
                            <li>
                                <a href="#what-is-a-visa" class="info-item">
                                    ...
                                    <div class="separator"></div>
                                    <span class="info-text-option">¿Qué es una visa?</span>
                                </a>
                            </li>
                            <li>
                                <a href="#categories-of-visa" class="info-item">
                                    <span class="info-number">02</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">Categorías de visa según el propósito del viaje</span>
                                </a>
                            </li>
                            <li>
                                <a href="#documents-of-travel" class="info-item">
                                    <span class="info-number">03</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">Documentos de viaje según el proceso de solicitud</span>
                                </a>
                            </li>
                            <li>
                                <a href="#have-more-questions" class="info-item">
                                    <span class="info-number">04</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">¿Tienes más preguntas? ¡Contacta a nuestros
                                        expertos!</span>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="info-col-article">
                <p class="many-text">¿Estás pensando en estudiar en los Estados Unidos o disfrutar de unas
                ...
                <p class="all-text">Este artículo te explica los distintos tipos de visas,
                    ...
                    y obtener los documentos que necesitas para explorar el mundo.
                </p>

                <h2 id="what-is-a-visa" class="subtitle">¿Qué es una visa?</h2>

                <p class="many-text">Una visa es un documento oficial o un sello en tu
                ...
                <p class="all-text">Obtener una visa suele requerir un proceso de solicitud en
                    ...
                    de destino. Los requisitos y el proceso para conseguir una visa pueden variar bastante entre países, ya
                    que cada uno tiene sus
                    propias consideraciones de seguridad, económicas y diplomáticas.
                </p>

                <h2 id="categories-of-visa" class="subtitle">Categorías de visa según el propósito del viaje</h2>

                <p class="many-text">El motivo de tu viaje definirá qué tipo de visa necesitas.
                    ...
                    <strong>tipos de visas más comunes.</strong>
                </p>

                <h3 class="subtitle-sub">Visa de turista</h3>

                <p class="many-text">Cuando estás planeando unas vacaciones, normalmente
                ...
                <p class="all-text">Este tipo de visa es una <strong>visa de no
                    ...
                    de regresar
                    a tu país de origen. Las autoridades de inmigración suelen pedir los siguientes documentos:
                </p>
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Fotografías tamaño pasaporte. Usa el <a href="/" class="text-link" target="_blank"
                            rel="nofollow">servicio de fotos para pasaporte</a> de iVisa si necesitas una.</li>
                    <li class="list-item">Prueba de alojamiento</li>
                    <li class="list-item">Billete de avión de regreso</li>
                ...
                <p class="all-text"><strong>iVisa te facilita la solicitud en línea de visas
                    ...
                    unos clics o
                    para recibir una guía completa en el caso de visas más complejas, como la B1/B2 para visitar los EE.UU.!
                    Utiliza
                    la <a href="/" class="text-link" target="_blank" rel="nofollow">herramienta de
                        verificación de visas</a> para comprobar si hay una visa de turista disponible para tu próximo
                    destino.
                </p>

                <h3 class="subtitle-sub">Visa de negocios</h3>

                <p class="many-text">Este tipo de visa está destinado a los viajeros de
                    negocios. Puedes
                ...
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Fotografías tamaño pasaporte. Recuerda que puedes usar el
                        <a href="/" target="_blank" class="text-link" rel="nofollow">servicio de fotos para pasaporte</a>.
                    </li>
                    <li class="list-item">Carta de invitación de la empresa anfitriona</li>
                    <li class="list-item">Prueba de alojamiento</li>
                    <li class="list-item">Billete de avión de regreso</li>
                    <li class="list-item">Fondos suficientes para cubrir tus gastos durante la estadía</li>
                </ul>
                ...
                <p class="many-text">Esta visa es necesaria para <strong>tratamiento
                        médico</strong>.
                ...
                <ul class="list-categories">
                    <li class="list-item">Certificado médico de una institución médica reconocida</li>
                    <li class="list-item">Fondos suficientes para cubrir tus gastos médicos durante la estadía</li>
                </ul>

                <h3 class="subtitle-sub">Visa de trabajo</h3>

                <p class="many-text">Las visas de trabajo permiten <strong>trabajar legalmente
                        en el país</strong>.
                ...
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Fotografías tamaño pasaporte</li>
                    <li class="list-item">Contrato de trabajo de la empresa anfitriona</li>
                    <li class="list-item">Prueba de alojamiento</li>
                    <li class="list-item">Billete de avión de regreso</li>
                    <li class="list-item">Fondos suficientes para cubrir tus gastos durante la estadía</li>
                ...
                <p class="many-text">¿Te gustaría estudiar en el extranjero? Necesitas
                ...
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Fotografías tamaño pasaporte</li>
                    <li class="list-item">Carta de aceptación de la institución educativa</li>
                    <li class="list-item">Prueba de alojamiento</li>
                    <li class="list-item">Fondos suficientes para cubrir tus gastos durante la estadía</li>
                    <li class="list-item">Calificaciones educativas</li>
                </ul>

                <h3 class="subtitle-sub">Visa Au Pair</h3>

                <p class="many-text">Algunos países ofrecen una visa Au Pair, destinada a
                    quienes desean
                    <strong>vivir legalmente en el país mientras cuidan a niños</strong> en una familia anfitriona aprobada
                    por el programa.
                    Por lo general, esta visa es válida por 12 meses. En Estados Unidos, por ejemplo, se llama visa J-1 y
                    forma parte
                ...
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Contrato firmado con la familia anfitriona</li>
                    <li class="list-item">Antecedentes penales limpios</li>
                    <li class="list-item">Certificado de secundaria</li>
                    <li class="list-item">Carta de motivación</li>
                    <li class="list-item">Prueba de habilidades lingüísticas</li>
                    <li class="list-item">Tener entre 18 y 30 años</li>
                </ul>

                <h3 class="subtitle-sub">Visa nómada</h3>

                <p class="many-text">El <strong>trabajo remoto</strong> está en auge. Al no
                    necesitar ir
                    a la oficina, las personas pueden trabajar desde cualquier lugar con conexión a internet. Los países han
                    visto esta
                    tendencia y ahora ofrecen visas nómadas, permitiendo a estos viajeros quedarse más tiempo si pueden
                    demostrar ingresos
                    regulares.
                </p>
                <p class="all-text">Por ejemplo, puedes disfrutar de tu vida trabajando de
                    ...
                    solo necesitas completar una solicitud en línea en unos minutos. Los requisitos pueden variar según el
                    país, pero
                    podrías necesitar algunos de los siguientes documentos:
                </p>
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Fotografías tamaño pasaporte</li>
                    <li class="list-item">Prueba de trabajo remoto</li>
                    <li class="list-item">Prueba de alojamiento</li>
                ...
                <p class="many-text">Conseguiste una excelente oportunidad laboral en otro
                    país,
                ...
                <ul class="list-categories">
                    <li class="list-item">Un pasaporte vigente</li>
                    <li class="list-item">Fotografías tamaño pasaporte</li>
                    <li class="list-item">Certificado de matrimonio</li>
                    <li class="list-item">Prueba de que el cónyuge tiene fondos suficientes para cubrir tus gastos</li>

                </ul>

                <h3 class="subtitle-sub">Visa de retiro</h3>

                <p class="many-text">Has trabajado mucho y ahora quieres experimentar una
                ...
                <p class="many-text">Hay varias formas de solicitar las visas mencionadas. Cada
                    país establece el
                    ...
                    algunos ciudadanos pueden visitar los Estados Unidos con el <a href="/estados-unidos/p/esta"
                        class="text-link">ESTA</a>, una autorización de viaje
                    electrónica que se puede solicitar en línea, mientras que otros deben obtener una <a
                ...
                <p class="many-text">Algunos países cuentan con un <strong>sistema electrónico
                    ...
                    rápido y sencillo: solo necesitas completar un formulario en línea en unos pocos clics y recibirás el
                    documento por correo
                    electrónico. Por lo general, tiene pocos requisitos, se procesa rápidamente y el <strong>proceso es
                        completamente en línea</strong>,
                    vinculando la visa electrónicamente a tu pasaporte.
                </p>

                <h3 class="subtitle-sub">ETA: Autorización electrónica de viaje</h3>
                <p class="many-text">Una <strong>ETA (autorización electrónica de
                    ...
                    de tu viaje y te permite abordar un vuelo hacia tu destino. Con una ETA, las autoridades locales pueden
                    rastrear a los turistas
                    recopilando información personal y de viaje de los formularios digitales enviados por los viajeros. Al
                    llegar, puede que te pidan
                    mostrar tu ETA en inmigración.
                </p>

                <h3 class="subtitle-sub">Visa a la llegada</h3>
                <p class="many-text">Algunos países ofrecen esta visa a través de un
                    ...
                    un formulario en línea antes de abordar, mientras que en otros, <strong>todo el proceso de solicitud se
                        realiza en el
                        aeropuerto</strong>. Esto puede ser bastante inconveniente, ya que suele implicar largas esperas en
                    fila para obtener la visa.
                    Sin embargo, al menos evitarás el proceso burocrático de la embajada. Asegúrate de llevar todos los
                    documentos necesarios,
                    o podrías tener que regresar a casa antes de explorar el país.
                </p>

                <h3 class="subtitle-sub">Visa en papel</h3>
                <p class="many-text">A diferencia de otros métodos de solicitud, una visa en
                    papel es una
                    <strong>visa física emitida por un consulado o embajada</strong> y se adhiere a una página de tu
                    pasaporte. Para obtenerla,
                    podrías necesitar hacer la solicitud en persona o por correo, y el proceso puede demorar varios días o
                    incluso semanas.
                    Con una visa en papel, también es probable que tengas que presentar documentación adicional y pasar por
                    una entrevista.
                    Generalmente, esta es la opción que se utiliza cuando necesitas quedarte en el país por periodos más
                    largos, como en el caso
                    de visas de trabajo o estudio.
                </p>

                <h4>Solicitud de visa guiada</h4>
                <p class="many-text">No tienes que lidiar con este proceso complicado por tu
                    ...
                    para ayudarte en
                    cada paso. Te ofrecemos un formulario de solicitud más corto y fácil de entender en comparación con los
                    de la embajada.
    ...
    <div class="info-related">
        ...
        <div class="card-container">
            <a class="card-0" href="#">
                ...
                alt="Guía de tarjetas de llegada: Información clave para viajeros cover image" width="425" height="200" data-ll-status="loaded" 
