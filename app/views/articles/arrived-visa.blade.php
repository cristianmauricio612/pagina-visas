    ...
    <div class="info-visa-container">
        <div class="return-page">
            <div class="small-title-page">
                ...
                <span> > </span>
                <b class="name-page">Guía completa de visa a la llegada: Definición, proceso, requisitos y más.</b>
            </div>
        </div>
        <div class="title-page">
            Guía completa de visa a la llegada: Definición, proceso, requisitos y más.
        </div>
        <div class="text-page">
            <div class="info-text">
    ...
    <div class="info-container">
        <div class="division">
                ...
                <div class="info-table">
                    <div style="padding: 32px">
                        ...
                        <ul style="list-style: none; padding-left: 0%; margin-bottom: 0%;">
                            <li>
                                <a href="#what-is-a-arrived-visa" class="info-item">
                                    <span class="info-number">01</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">¿Qué es una visa a la llegada?</span>
                                </a>
                            </li>
                            <li>
                                <a href="#destinations-of-arrived-visa" class="info-item">
                                    <span class="info-number">02</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">Destinos populares que ofrecen visas a la llegada</span>
                                </a>
                            </li>
                            <li>
                                <a href="#how-many-time" class="info-item">
                                    <span class="info-number">03</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">¿Cuánto tiempo puedes quedarte en el pais con una visa
                                        a la llegada?</span>
                                </a>
                            </li>
                            <li>
                                <a href="#how-get-arrived-visa" class="info-item">
                                    <span class="info-number">04</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">¿Cómo obtener una visa a la llegada con
                                        preinscripción?</span>
                                </a>
                            </li>
                            <li>
                                <a href="#arrived-visa-airport" class="info-item">
                                    <span class="info-number">05</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">Visa a la llegada en el aeropuerto</span>
                                </a>
                            </li>
                            <li>
                                <a href="#arrived-visa-vs-eVisa" class="info-item">
                                    <span class="info-number">06</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">Visa a la llegada vs. eVisa: ¿Cuáles son las
                                        diferencias?</span>
                                </a>
                            </li>
                            <li>
                                <a href="#why-choose-iVisa" class="info-item">
                                    <span class="info-number">07</span>
                                    <div class="separator"></div>
                                    <span class="info-text-option">¿Por qué elegir iVisa para solicitar tu visa?</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="info-col-article">
                ...
                <p class="all-text">Cada vez más destinos ofrecen este tipo de visas que se obtienen al llegar,
                    simplificando el viaje para personas de todo el mundo.
                </p>
                ...
                <p class="all-text">A diferencia de una visa tradicional, no necesitas pasar por un largo proceso de
                    solicitud ni obtenerla con anticipación.
                </p>
                <p class="all-text">Recibirás tu visa en el mostrador correspondiente en el aeropuerto, ¡y estarás listo
                ...
                <p class="many-text">Indonesia ofrece una visa a la llegada para turistas y
                    ...
                    así evitas las filas al llegar y ahorras tiempo y esfuerzo.
                </p>
                ...
                <ul class="list-categories">
                    <li class="list-item">Maldivas</li>
                    <li class="list-item">Camboya</li>
                    <li class="list-item">India</li>
                    <li class="list-item">Kenia</li>
                    <li class="list-item">Nigeria</li>
                    <li class="list-item">Omán</li>
                    <li class="list-item">Turquía</li>
                    <li class="list-item">Tailandia</li>
                    <li class="list-item">Uganda</li>
                ...
                <p class="all-text"><strong>1. Verifica tu elegibilidad:</strong> Antes de viajar, comprueba si tu destino
                    ofrece una visa a la llegada para tu nacionalidad y el tipo de viaje que planeas.
                </p>

                <p class="all-text"><strong>2. Completa tus datos:</strong> Proporciona tus datos personales, como el número
                    de tu pasaporte, las fechas de viaje y tu información de contacto. Paga la tarifa de la visa con una
                    tarjeta de débito o crédito, todo en línea.
                </p>
                <p class="all-text">Por lo general, puedes llenar este formulario en el sitio web del gobierno o usar
                    nuestra plataforma o <a href="/download" class="text-link">app</a> para simplificar el proceso.
                </p>
                <p class="all-text"><strong>3. Llega a tu destino:</strong> En el aeropuerto o en la frontera, muestra tu
                    pasaporte y cualquier documentación necesaria. Si todo está en orden, te colocarán el sello o adhesivo
                    de la visa en tu pasaporte.
                </p>
                <p class="all-text">¡Eso es todo!</p>
                ...
                <p class="all-text">Si has completado una preinscripción para tu visa a la llegada, lleva contigo la
                    confirmación o el número de referencia.
                </p>
                ...
                <p class="all-text">Generalmente, puedes esperar pagar <strong>entre US$10 y US$30</strong>, dependiendo de
                    tu destino.
                </p>
                ...
                <p class="all-text">Te recomendamos planificar tu llegada a tu destino temprano en la mañana o tarde en la
                    noche para evitar las multitudes y las largas filas, especialmente durante la temporada alta de turismo.
                </p>
                ...
                <div class="vs-container">
                    <table class="table-vs">
                        <thead class="table-vs-header">
                            <tr class="row-table-vs">
                                <th class="column-static-header"></th>
                                <th>eVisa</th>
                                <th>Visa a la llegada</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="row-table-vs">
                                <td class="column-static"><strong>Proceso de solicitud</strong></td>
                                <td>Realiza la solicitud en línea antes de viajar.</td>
                                <td>Obtenla cuando aterrices. A veces se necesita preinscripción.</td>
                            </tr>
                            <tr class="row-table-vs-par">
                                <td class="column-static-par"><strong>Tiempo de procesamiento</strong></td>
                                <td>Generalmente se aprueba en unas pocas semanas.</td>
                                <td>Se aprueba en el momento.</td>
                            </tr>
                            <tr class="row-table-vs">
                                <td class="column-static"><strong>Tarifas de la visa</strong></td>
                                <td>Más barata que las visas tradicionales, pero siempre hay un costo.</td>
                                <td>Varía desde gratis (!) hasta US$30.</td>
                            </tr>
                            <tr class="row-table-vs-par">
                                <td class="column-static-par"><strong>Validez y extensiones</strong></td>
                                <td>De unas semanas a meses. Generalmente se puede extender en línea.</td>
                                <td>De unas semanas a meses. Generalmente se puede extender en línea.</td>
                            </tr>
                        </tbody>
                    </table>
