                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('blog.index') }}"
                                class="block py-2 px-4 rounded-md bg-gray-100 hover:bg-gray-200">
                                Todos los artículos
                            </a>
                        </li>
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            @else
                                                <img class="h-8 w-8 rounded-full"
                                                    src="https://randomuser.me/api/portraits/men/{{ $articulo->id % 80 }}.jpg"
                                                    alt="Autor">
                                            @endif
                                        </div>
                                        <div class="ml-3">
                    ...
                    @if($totalPages > 1)
                        <div class="flex justify-center mt-10">
                            <div class="inline-flex shadow-sm">
                                @if($page > 1)
                                    <a href="?page={{ $page - 1 }}"
                                        class="py-2 px-4 border border-gray-300 bg-white hover:bg-gray-50 rounded-l-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M15 19l-7-7 7-7" />
                                ...
                                @for($i = 1; $i <= $totalPages; $i++)
                                    <a href="?page={{ $i }}"
                                        class="py-2 px-4 border border-gray-300 {{ $i == $page ? 'bg-blue-50 text-blue-600 font-medium' : 'bg-white hover:bg-gray-50' }}">
                                        {{ $i }}
                                    </a>
                                @endfor
                                ...
                                @if($page < $totalPages)
                                    <a href="?page={{ $page + 1 }}"
                                        class="py-2 px-4 border border-gray-300 bg-white hover:bg-gray-50 rounded-r-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 5l7 7-7 7" />
