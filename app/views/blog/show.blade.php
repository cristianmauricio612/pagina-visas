    ...
    <div class="mt-12 border-t pt-10">
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="prose prose-lg max-w-none prose-ul:list-disc prose-ol:list-decimal prose-li:marker:text-gray-500">
                                    ...
                                    <a href="{{ $popular->url() }}" class="block">
                                        <div class="relative mb-3 overflow-hidden rounded-lg">
                                            @if($popular->tieneImagen())
                                                <img src="{{ $popular->imagen }}" alt="{{ $popular->titulo }}" class="w-full h-40 object-cover group-hover:opacity-90 transition">
                                            @else
                ...
                <a href="{{ $relacionado->url() }}" class="block">
                    <div class="relative">
                        @if($relacionado->tieneImagen())
                            <img src="{{ $relacionado->imagen }}" alt="{{ $relacionado->titulo }}" class="w-full h-40 object-cover">
                        @else
                            <div class="w-full h-40 flex items-center justify-center"
